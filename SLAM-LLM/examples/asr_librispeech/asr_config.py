...
class DataConfig:
    ...
    train_data_path: Optional[str] = "/Users/luyuhao/examples/demo/SLAM-LLM/examples/asr_librispeech/train_data.jsonl"
...
class LogConfig:
    ...
    wandb_dir: str = "/Users/luyuhao/examples/test_wandb"
    wandb_entity_name: str = "project_name"
    wandb_project_name: str = "project_name"
    wandb_exp_name: str = "exp_name"
    log_file: str = "/Users/luyuhao/examples/test.log"
    log_interval: int = 5
